...
export default defineComponent({
	...
	methods: {
		...
		async loadItemsFromSharePoint() {
			if (SharePointTools.isProduction()) this.items = await sp.web.lists.getByTitle(this.listName).getItemsByCAMLQuery({ ViewXml: "<View><Query><OrderBy><FieldRef Name='ID' Ascending='FALSE' /></OrderBy></Query></View>" });
